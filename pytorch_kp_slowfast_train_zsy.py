...
class Feeder(Dataset):
    ...
    def __init__(self, data_path, label_path, debug=False, normalization=False, random_shift=False, is_vector=False):
        """
    ...
    def __getitem__(self, index):
        ...
        if self.normalization:
            ...
            if self.is_vector:
                ...
                data_numpy_slow[2,:,0,:] = data_numpy_slow[2,:,0,:] - data_numpy_slow[2,:,0,0].mean(axis=0)
                ...
                data_numpy_fast[2,:,0,:] = data_numpy_fast[2,:,0,:] - data_numpy_fast[2,:,0,0].mean(axis=0)
            else:
                ...
                data_numpy_slow[2,:,:,:] = data_numpy_slow[2,:,:,:] - data_numpy_slow[2,:,0,0].mean(axis=0)
                data_numpy_fast[0,:,:,:] = data_numpy_fast[0,:,:,:] - data_numpy_fast[0,:,0,0].mean(axis=0)
                data_numpy_fast[1,:,:,:] = data_numpy_fast[1,:,:,:] - data_numpy_fast[1,:,0,0].mean(axis=0)
                data_numpy_fast[2,:,:,:] = data_numpy_fast[2,:,:,:] - data_numpy_fast[2,:,0,0].mean(axis=0)

        if self.random_shift:
            if self.is_vector:
                data_numpy_slow[0,:,0,:] += random.random() * 20 - 10.0
                data_numpy_slow[1,:,0,:] += random.random() * 20 - 10.0
                data_numpy_slow[2,:,0,:] += random.random() * 20 - 10.0
                data_numpy_fast[0,:,0,:] += random.random() * 20 - 10.0
                data_numpy_fast[1,:,0,:] += random.random() * 20 - 10.0
                data_numpy_fast[2,:,0,:] += random.random() * 20 - 10.0
            else:
                data_numpy_slow[0,:,:,:] += random.random() * 20 - 10.0
                data_numpy_slow[1,:,:,:] += random.random() * 20 - 10.0
                data_numpy_slow[2,:,:,:] += random.random() * 20 - 10.0
                data_numpy_fast[0,:,:,:] += random.random() * 20 - 10.0
                data_numpy_fast[1,:,:,:] += random.random() * 20 - 10.0
                data_numpy_fast[2,:,:,:] += random.random() * 20 - 10.0
